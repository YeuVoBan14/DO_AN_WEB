    ...
    <body>
        ...
        <div class="container">
            <form method="post">
                ...
                <div class="mb-3">
                    <label for="mau_sp" class="form-label">Màu Sắc</label>
                    <input type="text" class="form-control" id="mau_sp" name="mau_sp" value="<%=mau_sp%>">
                </div>
                <div class="mb-3">
                    <label for="soluong_ton" class="form-label">Số Lượng</label>
                    <input type="text" class="form-control" id="soluong_ton" name="soluong_ton" value="<%=soluong_ton%>">
                </div>
                <div class="mb-3">
                    <label for="hinh_anh_sp" class="form-label">Hình Ảnh</label>
