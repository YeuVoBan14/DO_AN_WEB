...
<body>
      ...
      <label for="check" class="checkbtn">
        ...
        <ul>
          ...
          <li><%
                ...
                %>
                    <span class="welcome-mess">Welcome <%=Session("ten_kh")%>!</span>
    ...
    <div class="productmain" id="product">
      <%
...
<!-- Pagination links -->
  ...
  <ul class="page_number">
    <% if (pages>1) then 
        for i= 1 to pages
    %>
    <li class="page_item <%=checkPage(Clng(i)=Clng(page),"active")%>"><a class="page_link" href="test.asp?page=<%=i%>#product"><%=i%></a></li>
    <%
        next
        end if
    %>
