        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./client.asp" class="nav-link ">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Client</p>
                </a>
              </li>
        ...
        <tbody>
            ...
            %>
                    <tr>
                        ...
                        <td><%=Result("hinh_anh_sp")%></td>
                        <td>
                          <a href="./addproduct.asp" class="btn btn-primary">Add</a>
                      </td>
                        <td>
                            <a href="editproduct.asp?ma_sp=<%=Result("ma_sp")%>" class="btn btn-secondary">Edit</a>
                        </td>
                        <td>
                            <a href="deleteproduct.asp?ma_sp=<%=Result("ma_sp")%>" class="btn btn-danger">Delete</a>
                        </td>
                    </tr>
            <%
                    Result.MoveNext
